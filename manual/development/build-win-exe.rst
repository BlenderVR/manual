...
Please download the `BlenderVR Installer source code <ftp://blendervrdownloads:blendervr@ftp.limsi.fr/BlenderVR_W7_Installer/BlenderVR_Win7_Installer_dev.zip>`_ before reading the next section.
